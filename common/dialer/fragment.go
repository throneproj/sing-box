...
// hiddify: TCP-level TLS ClientHello fragmentation. Splits the ClientHello
// record into several smaller TLS records (optionally sleeping between bursts)
// so SNI-based DPI can't reassemble the server name from a single packet.
